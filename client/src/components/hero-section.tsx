...
import CV from '../assets/Parth Chaudhary_Resume.pdf';
import { useEffect } from "react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10">
        <div className="animate-float">
          <img 
            ...
            className="w-52 h-52 rounded-full mx-auto mb-8 border-4 shadow-2xl object-cover"
          />
        </div>
        ...
        <div className="hero-buttons flex flex-col sm:flex-row gap-4 justify-center opacity-0 translate-y-8">
          ...
          <a href={CV} target="_blank" rel="noopener noreferrer">
            <Button
              variant="outline"
              className="backdrop-blur-sm bg-white/10 dark:bg-black/20 border-white/20 dark:border-gray-700/80 px-8 py-4 text-lg font-semibold transition-all duration-300 transform hover:scale-105"
            >
              Download CV
            </Button>
          </a>
